                ...
                <div class="card_body">
                    <div class="row d-flex">
                        <div class="col-sm-4 createSegment">
                            <a class="btn dim_button create_new" href="add_account"> <span class="glyphicon glyphicon-plus"></span> Tạo mới</a>
                        </div>
                        <div class="col-sm-8 add_flex">
                            <div class="form-group searchInput">
                                <label for="email">Search:</label>
                                <input type="search" class="form-control" onkeyup="myFunction()" id="filterbox" placeholder="Username ">
                            </div>
                        </div>
                    </div>
                        ...
                        <table style="width:100%;" id="filtertable" class="table cust-datatable dataTable no-footer">
                            ...
                            <c:forEach items="${accList}" var="acc">
                                <tr>
                                    ...
                                    <td><c:out value="${acc.type}"></c:out></td>
                                    ...
                                    <td>
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu dropdown_more">
                                                <li>
                                                    <a href="update_account?user=${acc.username }" target="_black">
                                                        <i class="fa fa-edit"></i>Edit
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="#" onclick="testDialogConfirm('${acc.username}')" target="_self">
