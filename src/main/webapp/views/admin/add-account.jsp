...
<input type="hidden" id="status" value="<%= request.getAttribute("status")%>">
   <div class="login">
        ...
        <form class="needs-validation" method="post" action="${pageContext.request.contextPath }/add_account">
    ...
    <script type="text/javascript">
		...
		if(status == "success"){
			swal("Xin chúc mừng!","Thêm tài khoản thành công ", "success");
		}
		else if(status == "invalidPassword"){
			swal("Oops!!","Password phải bao gồm số, chữ thường, chữ in hoa và ký tự đặc biệt","error");
		}
