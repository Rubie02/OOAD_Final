    	...
    	function testDialogConfirm(productId){
    		Swal.fire({
    			  ...
    			  if (result.isConfirmed) {
    				window.location.href="delete_product?pid=" + productId;
    			    Swal.fire(
    			      'Sản phẩm đã bị xóa',
    			      '',
    			      'success'
                ...
                <div class="card_body">
                    <div class="row d-flex">
                        <div class="col-sm-4 createSegment">
                            <a class="btn dim_button create_new" href="add_product"> <span class="glyphicon glyphicon-plus"></span> Tạo mới</a>
                        </div>
                        <div class="col-sm-8 add_flex">
                            <div class="form-group searchInput">
                                <label for="email">Search:</label>
                                <input type="search" class="form-control" onkeyup="myFunction()" id="filterbox" placeholder="Tên sản phẩm ">
                            </div>
                        </div>
                    </div>
                    <div class="overflow-x">
                        <table style="width:100%;" id="filtertable" class="table cust-datatable dataTable no-footer">
                            <thead>
                                <tr>
                                    <th style="min-width:50px;">ID Sản phẩm</th>
                            ...
                            <c:forEach items="${listP}" var="p">
                                <tr>
                                    ...
                                    <td><img class="img-fluid" src="${p.productImage}" style="width: 263.917px; height: 218.333px;"></td>
                                    ...
                                    <td>
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu dropdown_more">
                                                <li>
                                                    <a href="update_product?pid=${p.productId }" target="_black">
                                                        <i class="fa fa-edit"></i>Edit
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="#" onclick="testDialogConfirm('${p.productId}')" target="_self">
