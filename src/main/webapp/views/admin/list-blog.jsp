                ...
                <div class="card_body">
                    <div class="row d-flex">
                        <div class="col-sm-4 createSegment">
                            <a class="btn dim_button create_new" href="add_blog"> <span class="glyphicon glyphicon-plus"></span> Tạo mới</a>
                        </div>
                        <div class="col-sm-8 add_flex">
                            <div class="form-group searchInput">
                                <label for="email">Search:</label>
                                <input type="search" class="form-control" onkeyup="myFunction()" id="filterbox" placeholder="Tên bài viết ">
                            </div>
                        </div>
                    </div>
                    <div class="overflow-x">
                        <table style="width:100%;" id="filtertable" class="table cust-datatable dataTable no-footer">
                            <thead>
                                <tr>
                                    <th style="min-width:50px;">Tên bài viết</th>
                            ...
                            <c:forEach items="${listP}" var="p">
                                <tr>
                                    <td><c:out value="${p.blogName}"></c:out></td>
                                    <td><img class="img-fluid" src="${p.blogImage}" style="width: 263.917px; height: 218.333px;"></td>
                                    <td><c:out value="${p.details}"></c:out></td>
                                    ...
                                    <td>
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu dropdown_more">
                                                <li>
                                                    <a href="update_blog?bId=${p.blogId }" target="_black">
                                                        <i class="fa fa-edit"></i>Edit
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="#" onclick="testDialogConfirm('${p.blogId}')" target="_self">
