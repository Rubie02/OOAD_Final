      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
          	<p class="breadcrumbs"><span class="mr-2"><a href="Home">Home</a></span> <span>Thông tin đặt hàng</span></p>
            <h1 class="mb-0 bread">Thông tin đặt hàng </h1>
          </div>
        </div>
      </div>
    </div>
    				...
    				<div class="cart-list">
	    				<table class="table">
						    ...
						    <c:forEach items="${list_orders}" var="list_o">
						      <tr class="text-center">
						        <td class="product-remove"><a href="cancel_order?odId=${list_o.odId }"><span class="ion-ios-close"></span></a></td>
						        
						        <td class="image-prod"><div class="img" style="background-image:url(${list_o.product.productImage });"></div></td>
						        
						        <td class="product-name">
						        	<h3>${list_o.product.productName }</h3>
						        	
						        </td>
						        <td class="product-name">
						        	<h3>${list_o.order.orderDate }</h3>
						        	
						        </td>
						        
						        <td class="price">${list_o.product.price }</td>
						        ...
						        <td class="total">${list_o.product.price*list_o.quantity }</td>
						      </tr><!-- END TR-->
    			...
    			<div class="col-lg-4 mt-5 cart-wrap ftco-animate">
    				<div class="cart-total mb-3">
    					...
    					<p class="d-flex">
                            ...
                            <c:forEach items="${list_orders }" var="list_o">
                            	<c:set var="total" value="${total+list_o.quantity*list_o.product.price }"/>
                            	</c:forEach> 
    						<span>${total } VNĐ</span>
    					</p>
    					<p class="d-flex">
    				...
    				<p><a href="Shop" class="btn btn-primary py-3 px-4">Tiếp tục mua hàng</a></p>
    				<p><a href="Cart" class="btn btn-primary py-3 px-4">Quay lại giỏ hàng</a></p>
    			</div>
    		</div>
			</div>
		</section>
