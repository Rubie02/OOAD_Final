              ...
              <div class="comment-form-wrap pt-5">
                ...
                <form class="p-5 bg-light">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" value="${sessionScope.acc.username }" id="name" disabled>
                  </div>
                  <div class="form-group">
                    <label for="email">Password</label>
                    <input type="password" class="form-control" placeholder="${account.password }" id="password" disabled>
                  </div>
                  <div class="form-group">
                    <label for="email">Name</label>
                    <input type="text" class="form-control"  placeholder="${customer.cusName }" id="email" >
                  </div>
                  <div class="form-group">
                    <label for="email">Email</label>
                    <input type="email" class="form-control" placeholder="${account.email }" id="email" disabled>
                  </div>
                  <div class="form-group">
                    <label for="website">Địa chỉ</label>
                    <input type="text" class="form-control" placeholder="${customer.cusAddress }" id="website" disabled>
                  </div>

                  <div class="form-group">
                    <label for="message">Số điện thoại</label>
                    <input type="text" class="form-control" placeholder="${customer.cusPhoneNumber }" id="message" disabled>
                  </div>
                  <div class="form-group">
                    <p><a href="update_cus?username=${sessionScope.acc.username }" class="btn py-3 px-4 btn-primary">Chỉnh sửa</a></p>
                  </div>
