      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
          	<p class="breadcrumbs"><span class="mr-2"><a href="index.html">Home</a></span> <span>Mua hàng</span></p>
            <h1 class="mb-0 bread">Mua hàng </h1>
          </div>
        </div>
      </div>
    </div>
    			...
    			<div class="col-lg-4 mt-5 cart-wrap ftco-animate">
    				<div class="cart-total mb-3">
    					<h3>Điền thông tin</h3>
  						...
  						<form action="buy_in_cart" method="post" class="info">
			              <div class="form-group">
			              	<label for="">Họ và tên</label>
			                <input type="text" name="cusName" placeholder="enter your name" value="${cus.cusName }" class="form-control text-left px-3" >
			              </div>
			              <div class="form-group">
			              	<label for="">Địa chỉ</label>
			                <input type="text" name="cusAddress" placeholder="enter your address" value="${cus.cusAddress }" class="form-control text-left px-3">
			              </div>
			              <div class="form-group">
			              	<label for="">Số điện thoại</label>
			                <input type="text" name="cusPhoneNumber" placeholder="enter your phone" value="${cus.cusPhoneNumber }" class="form-control text-left px-3">
			              </div>
			              <div class="form-group">
			              	<label for="">Username</label>
			                <input type="text" name="username" value="${sessionScope.acc.username }" class="form-control text-left px-3" placeholder="">
			              </div>
			       	            <p><a href="order_list" class="btn btn-primary py-3 px-4">Mua hàng</a></p>
	            		</form>
